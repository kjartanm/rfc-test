...
trinn -\> tema -\> artikkel]{.underline}'. Hvis strukturen da er
'[Matematikk -\> 5. trinn -\> Brøk -\> Brøk og tallinje]{.underline}',
...
'[Matematikk for 5. trinn -\> Brøk og tallinje]{.underline}' uten
